...
class CycleGANModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B', 'ene_A', 'ene_B'] # rui
        ...
        if self.isTrain:
            ...
            self.criterionEnergy = networks.EnergyLossTorch(opt.batchSize, cell_range=16).to(self.device) # rui
    ...
    def backward_G(self):
        ...
        # combined loss
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + self.loss_ene_A + self.loss_ene_B # rui
